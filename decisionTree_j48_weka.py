...
# ['option:', ['-C', '0.15', '-M', '2'], 'kappa: ', 0.601963928972143] was the best
...
cls.options =  ["-C", "0.15", "-M", "2"]

from weka.classifiers import Evaluation
from weka.core.classes import Random
evl = Evaluation(data)
evl.crossvalidate_model(cls, data, 10, Random(1), pred_output)

# View complete summary of the selected model
print(evl.summary())
